  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="楼层信息" prop="loucengxinxi">
          <el-select v-model="ruleForm.loucengxinxi" placeholder="请选择楼层信息">
            <el-option
                v-for="(item,index) in loucengxinxiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="楼层信息" prop="loucengxinxi">
	      <el-input v-model="ruleForm.loucengxinxi"
                placeholder="楼层信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="座位" prop="zuowei">
              <el-input v-model="ruleForm.zuowei" 
                placeholder="座位" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="预约开始" prop="yuyuekaishi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.yuyuekaishi" 
                type="datetime"
                placeholder="预约开始">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yuyuekaishi" label="预约开始" prop="yuyuekaishi">
              <el-input v-model="ruleForm.yuyuekaishi" 
                placeholder="预约开始" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="预约结束" prop="yuyuejieshu">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.yuyuejieshu" 
                type="datetime"
                placeholder="预约结束">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yuyuejieshu" label="预约结束" prop="yuyuejieshu">
              <el-input v-model="ruleForm.yuyuejieshu" 
                placeholder="预约结束" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dizhi = true;
            continue;
	            	            ...
	            	            if(o=='loucengxinxi'){
            this.ruleForm.loucengxinxi = obj[o];
	    this.ro.loucengxinxi = true;
            continue;
          }
	            	            if(o=='zuowei'){
	    ...
	    this.ro.zuowei = true;
            continue;
	            	            ...
	            	            if(o=='yuyuekaishi'){
            this.ruleForm.yuyuekaishi = obj[o];
	    this.ro.yuyuekaishi = true;
            continue;
          }
	            	            if(o=='yuyuejieshu'){
            this.ruleForm.yuyuejieshu = obj[o];
	    this.ro.yuyuejieshu = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                  ...
                                                                                                                  this.loucengxinxiOptions = "一层,两层,三层,四层,五层,六层".split(',')
                                                                                                                                                          },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
        url: `tushuguanxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tushuguanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tushuguanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
